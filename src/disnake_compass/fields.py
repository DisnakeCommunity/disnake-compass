...
def get_parser(
    ...
    ----------
    field:
        The field for which to get the :class:`disnake_compass.api.Parser`.

    Returns
    -------
    :class:`disnake_compass.api.Parser`
...
def get_field_type(
    ...
    :class:`TypeError`
        ...
        :func:`attrs.field` instead of :func:`disnake_compass.field() <.field>` to
        define a field.
    ...
    if FieldMetadata.FIELDTYPE not in field.metadata:
        ...
        msg = (
            ...
            f" recognised by disnake-compass. Please only construct fields"
            f" through functions provided by disnake-compass."
            f" See the 'disnake_compass.fields' submodule for possibilities."
        )
        raise TypeError(msg)
...
def field(
    default: typing.Union[_T, attrs.NothingType] = attrs.NOTHING,
    *,
